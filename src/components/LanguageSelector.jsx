...
const LanguageSelector = ({ changeLanguage, currentLanguage }) => {
  ...
  return (
    ...
    <Popover className="relative">
      <PopoverButton className="flex items-center gap-2 px-4 py-2 text-sm  rounded bg-white-500 text-blue transition-transform duration-200 transform hover:scale-110">
        ...
        <div className="flex flex-col">
          ...
          {languages.map((lang) => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm text-left transition-transform duration-200 transform hover:scale-105 ${
